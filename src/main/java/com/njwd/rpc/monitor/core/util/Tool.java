...
public class Tool {
	...
	public static boolean isMatch(URL consumerUrl, URL providerUrl,boolean isIpport) {
		...
		String consumerVersion = consumerUrl
				.getParameter(Constants.VERSION_KEY);
		String consumerClassifier = consumerUrl.getParameter(
				Constants.CLASSIFIER_KEY, Constants.ANY_VALUE);

		String providerGroup = providerUrl.getParameter(Constants.GROUP_KEY);
		String providerVersion = providerUrl
				.getParameter(Constants.VERSION_KEY);
		String providerClassifier = providerUrl.getParameter(
				Constants.CLASSIFIER_KEY, Constants.ANY_VALUE);
		//version 暂时不匹配
		//&& (Constants.ANY_VALUE.equals(consumerVersion) || StringUtils
		//.isEquals(consumerVersion, providerVersion))
		return (Constants.ANY_VALUE.equals(consumerGroup)
				|| StringUtils.isEquals(consumerGroup, providerGroup) || StringUtils
					.isContains(consumerGroup, providerGroup))
				
				&& (consumerClassifier == null
						|| Constants.ANY_VALUE.equals(consumerClassifier) || StringUtils
							.isEquals(consumerClassifier, providerClassifier));
	}

	public static boolean isMatchGroup(URL consumerUrl, URL providerUrl){
		String consumerGroup = consumerUrl.getParameter(Constants.GROUP_KEY);
		String providerGroup = providerUrl.getParameter(Constants.GROUP_KEY);
		return Constants.ANY_VALUE.equals(consumerGroup)
				|| StringUtils.isEquals(consumerGroup, providerGroup) || StringUtils
